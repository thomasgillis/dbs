...
zlib_info:
ifdef ZLIB_VER
	@$(zlib_template_opt) $(MAKE) --file=template.mak template_info
else
	@$(zlib_template_opt) $(MAKE) --file=template.mak template_info_none
endif

#-------------------------------------------------------------------------------
.PHONY: zlib_clean
zlib_clean: 
	@$(zlib_template_opt) $(MAKE) --file=template.mak tempalte_clean

#-------------------------------------------------------------------------------
.PHONY: zlib_reallyclean
zlib_reallyclean: 
	@$(zlib_template_opt) $(MAKE) --file=template.mak template_reallyclean
